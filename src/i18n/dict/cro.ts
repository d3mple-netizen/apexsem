...
export const croDict = defineDict(
  ...
  },
  {
    ...
    subtitle: 'Платный клик окупается, только если страница конвертит. Смотрим, совпадает ли она с объявлениями, понятна ли и где люди отваливаются.',
    ...
    formBody: (domain: string) => `Набросок регистрации в одно поле для ${domain}. Ничего никуда не уходит.`,
    workEmail: 'Рабочий email',
    formNote: 'Одно поле, без пароля и карты. Остальное спросишь после регистрации.',
    previewDone: 'Вот и вся регистрация',
    previewDoneHint: 'Это превью, никуда ничего не ушло.'
  }
);
