...
export const overview = defineDict(
  ...
  },
  {
    ...
    verdict: {
      ...
      mid: 'Крепкий претендент. До уровня 1 не хватает минус-слов и закрытых тематических кластеров.',
      low: 'Молодой домен. Начните с рекламы по горячим запросам, а параллельно добавьте schema-разметку и базовые ссылки.'
    },
    vectorsTitle: 'Главные метрики: реклама и поиск',
    fromCrawl: 'По скану главной',
    vectors: {
      technicalHealth: 'Техника и индексация',
    ...
    pipelineHint: 'Грубая оценка, если выйдете на целевой трафик',
    targetTraffic: 'Потолок трафика',
    current: 'Сейчас:',
    wasted: 'Лишние траты на рекламу',
    ...
    share: 'доля',
    paidSpend: 'Бюджет на рекламу/мес',
    topKeywords: 'Топ рекламных ключей',
