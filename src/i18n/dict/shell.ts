...
export const shell = defineDict(
  ...
  },
  {
    header: {
      ...
      account: 'Аккаунт',
      signedInAs: 'Твой аккаунт',
      signOut: 'Выйти'
    },
    hero: {
      title: 'Введи домен - получишь полную SEM-стратегию за 30 секунд.',
      lead: 'Ключи, объявления, правки лендинга и план на 90 дней. Все собрано из того, что реально есть на твоей главной.',
      proof: 'Бесплатно через Google-аккаунт: 3 анализа в день, карта не нужна. Демо-отчет ниже смотри без входа.',
      honesty: 'Любая цифра либо снята с твоей страницы, либо честно помечена как оценка.',
      features: [
        {
          term: 'Читает твой реальный сайт',
    ...
    search: {
      ...
      anotherLead: 'Найди ключи с высоким интентом, перекрой слив бюджета и убери все, что мешает конверсии.',
      ...
      source: {
        sample: (d: string) => `Демо-отчет для ${d}. Проверь свой домен - получишь живой.`,
      ...
      anonLeft: 'Чтобы проверять домены, нужен аккаунт. Демо-отчет смотри без входа.',
      anonCta: 'Войти через Google: 3 в день бесплатно',
      failed: 'Анализ не прошел. Проверь адрес и попробуй еще раз.'
    },
    plans: {
      close: 'Закрыть',
      ...
      lead: 'Начни бесплатно. На Pro переходи, когда упрешься в дневной лимит.',
      free: 'Free',
      pro: 'Pro',
      perMonth: '/мес',
      usedToday: 'Сегодня',
      ...
      proFeatures: [
        ...
        'Первым получишь синк с Google Ads и алерты о пересканах'
      ],
    ...
    gate: {
      title: 'Войди через Google и запусти бесплатный анализ',
      lead: (d: string | null) =>
    ...
    footer: {
      about: 'ApexSEM. SEM- и SEO-стратегия по твоей главной.',
