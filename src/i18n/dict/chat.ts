...
export const chat = defineDict(
  ...
  },
  {
    ...
    prompts: [
      ...
      'Набросай 3 заголовка для enterprise-клиентов',
      'Как попасть в ответы ChatGPT и Perplexity?',
      'Дай JSON-LD разметку для SaaS-продукта'
    ],
