...
export const common = defineDict(
  ...
  {
    estimate: 'Оценка',
    estimateHint: 'Прикидка по домену и нише, а не замер. Ориентируйтесь на порядок, а не на точную цифру.',
    measured: 'Замер',
    measuredHint: 'Посчитано по свежему скану главной.',
    sampleData: 'Демо',
    sampleHint: 'Демо-отчет для примера. Проверьте свой домен - получите живой отчет.',
    perMonth: '/мес',
